...
exports.enter = function() {
    ...
    var neuralConfig = require('neural_net_config').config;
    loadConfig(neuralConfig);

    var playingState = main.loadState('neural_net_playing');
    if (sim.ready)
        main.setState(playingState, neuralConfig);
    else {
